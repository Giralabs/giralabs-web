...
export const translations = {
  es: {
    ...
    service_1_details: "Construimos aplicaciones móviles excepcionales con un rendimiento impecable y una interfaz sumamente cuidada. Guiamos todo el proyecto a través de nuestras fases de descubrimiento, diseño UX/UI y desarrollo con Flutter para clientes de toda España, incluyendo Sevilla y Madrid.",
    ...
    service_3_details: "Digitalizamos las operaciones críticas de tu empresa para eliminar la ineficiencia del papel o de las hojas de cálculo inconexas. Diseñamos e implementamos software para empresas en regiones clave como Sevilla y Madrid, conectando departamentos, automatizando tareas y optimizando procesos.",
    ...
    service_5_details: "Desarrollamos soluciones de software complejas a la medida exacta de tus requisitos técnicos y de negocio. Con clientes en Sevilla, Madrid y el resto del país, construimos portales internos, APIs y plataformas SaaS escalables que se adaptan al crecimiento de tu empresa.",
    ...
    about_intro_p3: "Aunque nuestra sede principal está en Madrid, colaboramos estrechamente con clientes y empresas en Sevilla y el resto de España, ofreciendo un servicio de proximidad y alta calidad.",
  ...
  en: {
    ...
    about_intro_p3: "Although our main headquarters is in Madrid, we work closely with clients and companies in Seville and the rest of Spain, offering high-quality, localized services.",
