...
export const translations = {
  es: {
    ...
    projects_meta_title: "Bipsy | El producto que estamos construyendo",
    projects_meta_description: "Bipsy es la plataforma de reservas para belleza y bienestar que desarrollamos en Giralabs: una app para clientes y Bipsy Business para los negocios. Producto propio en desarrollo.",
    projects_sub: "No coleccionamos escaparates. Ahora mismo todo nuestro producto propio se llama Bipsy, y lo estamos construyendo a la vista de todos.",
    ...
    service_1_details: "Construimos aplicaciones móviles excepcionales con un rendimiento impecable y una interfaz sumamente cuidada. Guiamos todo el proyecto a través de nuestras fases de descubrimiento, diseño UX/UI y desarrollo con Flutter para clientes de toda España, desde nuestra base en Sevilla.",
    ...
    service_3_details: "Digitalizamos las operaciones críticas de tu empresa para eliminar la ineficiencia del papel o de las hojas de cálculo inconexas. Diseñamos e implementamos software para empresas de Sevilla, Andalucía y el resto de España, conectando departamentos, automatizando tareas y optimizando procesos.",
    ...
    service_5_details: "Desarrollamos soluciones de software complejas a la medida exacta de tus requisitos técnicos y de negocio. Con base en Sevilla y clientes en toda España, construimos portales internos, APIs y plataformas SaaS escalables que se adaptan al crecimiento de tu empresa.",
    ...
    projects_eyebrow: "EN EL LABORATORIO",
    projects_title: "Lo que estamos construyendo ahora.",
    projects_home_sub: "Un único producto propio, con todo el foco puesto encima. Así trabajamos también los proyectos de nuestros clientes.",
    project_bipsy_tag: "Reservas · Belleza y bienestar",
    project_bipsy_title: "Bipsy",
    project_bipsy_desc: "Dos apps, un mismo ecosistema: Bipsy para reservar en barberías, peluquerías y centros de estética, y Bipsy Business para que el negocio lo gestione todo desde el móvil.",
    project_bipsy_status: "En desarrollo",
    project_bipsy_meta: "iOS · Android · 2026",
    project_bipsy_cta: "Descubrir Bipsy",
    projects_app_client: "Bipsy · para quien reserva",
    projects_app_business: "Bipsy Business · para el negocio",
    projects_nda_title: "¿Y el trabajo que hacemos para clientes?",
    projects_nda_body: "Casi todo lo que construimos para terceros es suyo, no nuestro, y vive bajo acuerdo de confidencialidad. Lo que sí podemos abrirte de par en par es nuestro propio producto: cómo lo pensamos, cómo lo diseñamos y cómo lo estamos construyendo.",
    projects_nda_cta: "Ver nuestros servicios",

    // Bipsy announcement (modal / floating banner)
    bipsy_announce_title: "Bipsy ya está en desarrollo",
    bipsy_announce_text: "Hola, soy Bip. En Giralabs estamos construyendo <strong>Bipsy</strong>: la forma más simple de reservar en barberías, peluquerías y centros de estética… y de gestionarlos.",
    bipsy_announce_cta: "Ver el proyecto",
    bipsy_announce_dismiss: "Ahora no",
    bipsy_announce_close: "Cerrar aviso",
    ...
    about_tech_eyebrow: "TECNOLOGÍAS",
    about_tech_heading: "Tecnologías con las que creamos",
    tech_flutter_desc: "Desarrollo móvil multiplataforma con rendimiento nativo.",
    tech_swift_desc: "Aplicaciones nativas de iOS eficientes y fluidas.",
    tech_kotlin_desc: "Desarrollo nativo moderno y seguro para Android.",
    tech_react_desc: "Interfaces de usuario interactivas y componentes modulares.",
    tech_angular_desc: "Aplicaciones web robustas y estructuradas para empresas.",
    tech_astro_desc: "Sitios web estáticos ultrarápidos optimizados para SEO.",
    tech_java_desc: "Sistemas backend empresariales fiables y escalables.",
    tech_spring_desc: "Microservicios y APIs robustas listas para producción.",
    tech_supabase_desc: "Base de datos en tiempo real y backend as a service.",
    tech_mongodb_desc: "Base de datos NoSQL flexible para datos dinámicos.",
    tech_android_studio_desc: "Entorno de desarrollo oficial para ecosistema Android.",
    tech_xcode_desc: "Herramienta oficial de Apple para compilar en iOS y macOS.",
    ...
    legal_jurisdiction_desc: "Cualquier controversia relacionada con el uso de este sitio web estará sujeta a la legislación española y a la competencia de los Juzgados y Tribunales de la ciudad de Sevilla, renunciando expresamente a cualquier otro fuero.",
  ...
  en: {
    ...
    projects_meta_title: "Bipsy | The product we are building",
    projects_meta_description: "Bipsy is the booking platform for beauty and wellness we are building at Giralabs: an app for clients and Bipsy Business for the venues. Our own product, currently in development.",
    projects_sub: "We do not collect shop windows. Right now our entire in-house product is called Bipsy, and we are building it out in the open.",
    ...
    // Projects summary section
    projects_eyebrow: "IN THE LAB",
    projects_title: "What we are building right now.",
    projects_home_sub: "A single in-house product with all of our focus on it. This is exactly how we work on our clients' projects too.",
    project_bipsy_tag: "Booking · Beauty & wellness",
    project_bipsy_title: "Bipsy",
    project_bipsy_desc: "Two apps, one ecosystem: Bipsy to book at barbershops, hair salons and beauty studios, and Bipsy Business so the venue can run everything from the phone.",
    project_bipsy_status: "In development",
    project_bipsy_meta: "iOS · Android · 2026",
    project_bipsy_cta: "Discover Bipsy",
    projects_app_client: "Bipsy · for the client",
    projects_app_business: "Bipsy Business · for the venue",
    projects_nda_title: "What about the work we do for clients?",
    projects_nda_body: "Almost everything we build for others belongs to them, not to us, and lives under an NDA. What we can open up completely is our own product: how we think it, how we design it and how we are building it.",
    projects_nda_cta: "See our services",

    // Bipsy announcement (modal / floating banner)
    bipsy_announce_title: "Bipsy is now in development",
    bipsy_announce_text: "Hi, I'm Bip. At Giralabs we are building <strong>Bipsy</strong>: the simplest way to book at barbershops, hair salons and beauty studios… and to run them.",
    bipsy_announce_cta: "See the project",
    bipsy_announce_dismiss: "Not now",
    bipsy_announce_close: "Close notice",
    ...
    about_tech_eyebrow: "TECHNOLOGIES",
    about_tech_heading: "Technologies we build with",
    tech_flutter_desc: "Cross-platform mobile development with native performance.",
    tech_swift_desc: "Efficient and smooth native iOS applications.",
    tech_kotlin_desc: "Modern and secure native development for Android.",
    tech_react_desc: "Interactive user interfaces and modular components.",
    tech_angular_desc: "Robust and structured web applications for enterprises.",
    tech_astro_desc: "Ultra-fast static websites optimized for SEO.",
    tech_java_desc: "Reliable and scalable enterprise backend systems.",
    tech_spring_desc: "Robust microservices and production-ready APIs.",
    tech_supabase_desc: "Real-time database and backend-as-a-service.",
    tech_mongodb_desc: "Flexible NoSQL database for dynamic data models.",
    tech_android_studio_desc: "Official development environment for Android ecosystem.",
    tech_xcode_desc: "Apple's official tool for compiling on iOS and macOS.",
    ...
    legal_intro_desc: "This website is operated by Giralabs Software Studio S.L., with registered offices in Seville, Spain. For any inquiry, communication, or exercise of legal rights, you may contact our engineering and support team directly at support@giralabs.es.",
    ...
    legal_jurisdiction_desc: "Any dispute related to the use of this website shall be governed by Spanish law and subject to the exclusive jurisdiction of the Courts of the city of Seville, Spain.",
